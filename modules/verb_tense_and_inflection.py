		...
		if len(value['2,3']['def']) != 0: 
			...
			if value['2,3']['def'][0].endswith('an'):	
				if sw in [215,264]:
					...
					verb_inflection.append('s\u0101y' + pa_present_inflection_suffix [0] + ' ' + value['2,3']['def'][0]) 
				elif sw in [404,409]:
					verb_inflection.append('s\u0101y' + pa_present_inflection_suffix [4] + ' ' + value['2,3']['def'][0])
				elif sw in [405,410]:
					verb_inflection.append('s\u0101y' + pa_present_inflection_suffix [2] + ' ' + value['2,3']['def'][0]) 
				elif sw in [406,411]:
					verb_inflection.append('s\u0101y' + pa_present_inflection_suffix [3] + ' ' + value['2,3']['def'][0])
				elif sw in [407,412]:
					verb_inflection.append('s\u0101y' + pa_present_inflection_suffix [5] + ' ' + value['2,3']['def'][0]) 
